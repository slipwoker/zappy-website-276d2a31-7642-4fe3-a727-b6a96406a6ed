document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest && (input.name === 'name' || input.name === 'email' || input.name === 'phone' || input.name === 'message')) {
                clearError(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '276d2a31-7642-4fe3-a727-b6a96406a6ed',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '276d2a31-7642-4fe3-a727-b6a96406a6ed';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '276d2a31-7642-4fe3-a727-b6a96406a6ed';
